...
<body>
	...
	<header class="header menu_2">
		...
		<ul id="top_menu">
			...
			<li class="hidden_tablet"><a href=<?php echo site_url('/admissions/login')?> class="btn_1 rounded">Admission</a></li>
		</ul>
		<!-- /top_menu -->
		...
		<nav id="menu" class="main-menu">
			<ul>
				...
				<li><span><a href="#0">Schools</a></span>
					<ul>
						<li><a href="#0">Mini School </a></li>
						<li><a href="">Primary School</a></li>
						<li><a href="">Junior Secondary School</a></li>
						<li><a href="">Senior Seconary School</a></li>
	...
	<main>
		...
		<section class="header-video">
			...
			<div id="hero_video">
				<div>
					<h3><strong>Welcome to:</strong><br>Kingdom way Accademy</h3>
					<p>Where future leaders are arised, <strong>with best teaching, advance technologies</strong> to be the best in the world.</p>
				</div>
				<a href="#first_section" class="btn_explore hidden_tablet"><i class="ti-arrow-down"></i></a>
			</div>
			<!-- <img src="<?php echo base_url(); ?>/assets/img/video_fix.png" alt="" class="header-video--media" data-video-src="video/intro" data-teaser-source="video/intro" data-provider="" data-video-width="1920" data-video-height="960"> -->
			<!-- <video id="teaser-video" class="teaser-video" autoplay="true" loop="loop" mute="" data-video-src="video/intro" data-teaser-source="video/intro" data-provider="" data-video-width="1920" data-video-height="960" >
				<source src="<?php echo base_url();?> /assets/video/intro.ogv" type="video/ogg">
				<source src="<?php echo base_url();?> /assets/video/intro.mp4" type="video/mp4">  

			</video> -->
			<video id="teaser-video" class="header-video--media" autoplay="true" loop="loop" muted="" data-video-src="video/intro" data-teaser-source="video/intro" data-provider="" data-video-width="1920" data-video-height="960"  >
