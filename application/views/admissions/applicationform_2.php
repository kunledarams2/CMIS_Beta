...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/icon_fonts/css/all_icons.min.css">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/skins/square/grey.css">
...
<body id="admission_bg">
	...
	<script type='text/javascript'  src="<?php echo base_url(); ?>/assets/js/common_scripts.js"></script>
	...
	<script type='text/javascript'  src="<?php echo base_url(); ?>/assets/js/admission_func.js"></script>
	<script type='text/javascript'  src="<?php echo base_url(); ?>/assets/js/jquery.wizard.js"></script>
	<script type='text/javascript'  src="<?php echo base_url(); ?>/assets/js/jquery.validate.js"></script>
	<script type='text/javascript'  src="<?php echo base_url(); ?>/assets/js/jquery-ui-1.8.22.min.js"></script>
	<!-- <script type='text/javascript'  src="<?php echo base_url(); ?>/assets/js/admission_func.js"></script> -->
